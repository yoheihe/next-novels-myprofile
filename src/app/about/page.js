  ...
  return (
    <main className="main-global">
      ...
      <div className='about-profile'>
        ...
        <div>
          <h3 className='about-text'>大学在学中に劇団ひまわりに入団。劇団時代に脚本作成を行い、文章を書くようになる。幼少期は全く本を読まず国語の成績は中学まで偏差値30。高校受験を契機に国語と向き合うようになり、読書量も増えました。現在は小説投稿サイトカクヨムに小説を投稿中です。</h3>
        </div>
      </div>
      ...
      <div className="about-profile-container">
        ...
        <div className="about-profile-item">
          ...
          <h3 className="about-profile-text">
            文学部史学地理学科専攻。考古学に興味があり遺跡発掘にも参加しました。
          </h3>
        </div>
        ...
        <div className="about-profile-item">
          ...
          <h3 className="about-profile-text">
            休みの日の午前中に河川敷を走ってます。ジョギング後の昼寝が最高です。
          </h3>
        </div>
